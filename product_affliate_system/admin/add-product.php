                                ...
                                <form id="add_product">
                                    <div class="row">
                                        <div class="col-12 col-sm-6 form-group">
                                            ...
                                            <input type="text" required class="form-control" id="title" placeholder="Enter title ">
                                        </div>
                                        
                                        <div class="col-12 col-sm-6 form-group">
                                            <label for="link">Product link</label>
                                            <input type="text" required class="form-control" id="link" placeholder="Enter link">
                                        </div>
