  	...
  	*/
        ...
        */
        $('.sidebar-dropdown').on('mouseover', function () {
            // alert('b');
            var sub_menu_class = this.id;
            $('#sub'+sub_menu_class).addClass('sidebar-dropdown-active');
            // $(this).closest('.dropdown-sub-menu').addClass('sidebar-dropdown-active');
        });
         $('.sidebar-dropdown').on('mouseout', function () {
           var sub_menu_class = this.id;
             $('#sub'+sub_menu_class).removeClass('sidebar-dropdown-active');
            // $(this).closest('.dropdown-sub-menu').removeClass('sidebar-dropdown-active');
        });
